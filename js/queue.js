...
<<<<<<< HEAD
//  Файл: queue.js
//  Расположение: js/queue.js
//  Описание: Клиентская логика очереди воспроизведения видео. 
//  Отвечает за рендер списка, добавление/удаление элементов 
//  и обработку соответствующих Socket-событий.
=======
